...
def create_descriptor():
    ...
    investigation.title = "Simple ISA Investigation-cell-tracking"
    investigation.description = "A test to create an ISA representation of metadata in Masuzzo et al., 2016"
    investigation.submission_date = "2017-04-04"
    investigation.public_release_date = "2017-04-04"
    ...
    study = Study(filename="cell_tracking_Masuzzo_2016.txt")
    study.identifier = "s1"
    study.title = "experiment 1 of Masuzzo et al., SciRep, 2016"
    study.description = "A test to create an ISA representation of metadata in Masuzzo et al., 2016, Experiment 1"
    study.submission_date = "2017-04-04"
    study.public_release_date = "2017-04-04"
    ...
    contact = Person(first_name="Paola", last_name="Masuzzo",
                     affiliation="Ghent University", roles=[OntologyAnnotation(term='submitter')])
    study.contacts.append(contact)
    publication = Publication(
        title="An end-to-end software solution for the analysis of high-throughput single-cell migration data", author_list="Paola Masuzzo, Lynn Huyck, Aleksandra Simiczyjew, Christophe Ampe, Lennart Martens, Marleen Van Troys")
    publication.pubmed_id = "28205527 "
    ...
    study.materials['samples'] = batch_create_materials(
