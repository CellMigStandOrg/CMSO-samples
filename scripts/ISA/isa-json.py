...
def create_descriptor():
    ...
    investigation.title = "ISA Investigation-cell-tracking"
    investigation.description = "Single-cell analysis module of CellMissy, as described in Masuzzo et al., 2016"
    ...
    study.identifier = "s1"
    study.title = "Study Experiment 1 of Masuzzo et al., SciRep, 2016"
    study.description = "CellMissy single-cell migration analysis module."
    ...
    contact = Person(first_name="Paola", last_name="Masuzzo", affiliation="Ghent University", roles=[OntologyAnnotation(term='submitter')])
